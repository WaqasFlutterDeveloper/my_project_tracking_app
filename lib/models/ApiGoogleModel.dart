...
/// rows : [{"elements":[{"distance":{"text":"4.6 km","value":4630},"duration":{"text":"18 mins","value":1083},"status":"OK"}]}]
/// status : "OK"
...
class ApiGoogleModel {
  ...
  ApiGoogleModel.fromJson(dynamic json) {
  ...
  List<Rows>? _rows;
  String? _status;
ApiGoogleModel copyWith({  List<String>? destinationAddresses,
  List<String>? originAddresses,
  List<Rows>? rows,
  String? status,
}) => ApiGoogleModel(  destinationAddresses: destinationAddresses ?? _destinationAddresses,
...
/// elements : [{"distance":{"text":"4.6 km","value":4630},"duration":{"text":"18 mins","value":1083},"status":"OK"}]
...
/// distance : {"text":"4.6 km","value":4630}
/// duration : {"text":"18 mins","value":1083}
/// status : "OK"
